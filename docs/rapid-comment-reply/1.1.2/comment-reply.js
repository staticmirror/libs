...
addComment = (function( window, undefined ){
	...
	function cancelEvent( event ) {
		...
		if ( ! respondElement ) {
			if ((Object.prototype.toString.call(cancelLink.href) === '[object String]') && 
				(cancelLink.href.length > 1) &&
				(cancelLink.href.lastIndexOf('#') > -1) &&
				(cancelLink.href.lastIndexOf('#') < cancelLink.href.length - 2)) {
				// fallback get respond form id by href
				var respondElement = getElementById(cancelLink.href.substring(cancelLink.href.lastIndexOf('#') + 1));
			}
		}
